...
def create_HMM_graph_pseudocounts(emission_letters,alignment,t,ps):
    ...
    def transition_graph(graph):
        ...
        # create successor nodes and initialize the transition matrix with the pseudocount
        ...
        # calculate the probabilities for the transition matrix
            ...
            for seq_index in range(num_align):
                ...
                if len(current_column_list) >1:
                    if current_char != '-':
                        ...
                        current_column = current_column_list[1]               
                else:
                    current_column = current_column_list[0]
                    if current_char == '-' and current_column[0] == 'I':
                        continue
                    
                # count the number of dashes in the column
                ...
                # populate the transition matrix and graph with probabilities
        ...
        # normalize the ransition matrix
    ...
    def create_emission_matrix():
        ...
        # normalize the probabilities for the emission matrix and graph
